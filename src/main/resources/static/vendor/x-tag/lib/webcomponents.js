...
if (WebComponents.flags.shadow) {
    ...
    (function (scope) {
        ...
        var selectorRe = /([^{]*)({[\s\S]*?})/gim, cssCommentRe = /\/\*[^*]*\*+([^\/*][^*]*\*+)*\//gim,
            ...
            cssPseudoRe = /::(x-[^\s{,(]*)/gim, cssPartRe = /::part\(([^)]*)\)/gim, polyfillHost = "-shadowcsshost",
        ...
        var cssColonHostRe = new RegExp("(" + polyfillHost + parenSuffix, "gim"),
            ...
            selectorReSuffix = "([>\\s~+[.,{:][\\s\\S]*)?$", colonHostRe = /\:host/gim,
            colonHostContextRe = /\:host-context/gim, polyfillHostNoCombinator = polyfillHost + "-no-combinator",
